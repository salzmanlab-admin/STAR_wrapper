...
class_input = fread("/scratch/PI/horence/Roozbeh/single_cell_project/output/Engstrom_newgtf_cSM_10_cJOM_10_aSJMN_0_cSRGM_0/Engstrom_sim1_trimmed/test.txt",sep="\t",header = TRUE)
##################################
...
print("junctions with a single shared gene are processed")
...
class_input[,refName_newR1:=refName_ABR1]
class_input[fileTypeR1=="Aligned" & gene_strandR1A_new=="-",refName_newR1:=paste(chrR1B,":",geneR1B_uniq,":",juncPosR1B,":",gene_strandR1B_new,"|",chrR1A,":",geneR1A_uniq,":",juncPosR1A,":",gene_strandR1A_new,sep="")]
...
class_input[(fileTypeR1=="Chimeric") & (gene_strandR1A_new!=read_strandR1A), refName_newR1:=paste(chrR1B,":",geneR1B_uniq,":",juncPosR1B,":",gene_strandR1B_new,"|",chrR1A,":",geneR1A_uniq,":",juncPosR1A,":",gene_strandR1A_new,sep="")]
...
# deleting redundant columns from the class input fiel
