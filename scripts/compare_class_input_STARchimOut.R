...
class_input_priority_Align_file = list.files(directory,pattern = "class_input_priorityAlign.tsv")
...
#### write output files
write.table(class_input_priority_Align,paste(directory,"class_input_priorityAlign.tsv",sep = ""),quote = FALSE, row.names = FALSE, sep = "\t")
write.table(in_star_chim_not_in_classinput_prio_align,paste(directory,"in_star_chim_not_in_classinput_priority_Align.txt",sep = ""),quote = FALSE, row.names = FALSE, sep = "\t")
write.table(in_star_SJ_not_in_classinput_prio_align,paste(directory,"in_star_SJ_not_in_classinput_priority_Align.txt",sep = ""),quote = FALSE, row.names = FALSE, sep = "\t") 
