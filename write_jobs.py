...
def STAR_map(out_path, data_path, name, r_ends, assembly, gzip, cSM, cJOM, aSJMN, cSRGM, single, gtf_file, dep = ""):
...
#          gtf_file = "/share/PI/horence/circularRNApipeline_Cluster/index/{}_genes.gtf".format(assembly)
          ...
          for name in names:
            ...
            if run_map:
              ...
              map_jobid = STAR_map(out_path, data_path, name, r_ends, assembly, gzip, cSM, cJOM, aSJMN, cSRGM, single, gtf_file, dep = ":".join(job_nums))
