...
#SBATCH --nodes=1
#SBATCH --mem=500
#SBATCH --dependency=afterany:52051959:52051960
#SBATCH --kill-on-invalid-dep=yes
date
python3 scripts/create_log.py -i /scratch/PI/horence/Roozbeh/single_cell_project/output/TS_pilot_smartseq_cSM_10_cJOM_10_aSJMN_0_cSRGM_0// -j GLM_B107924_I6_S234.52051959 log_B107924_I6_S234.52051960
date
