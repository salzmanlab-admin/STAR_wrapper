...
def class_input(out_path, name, assembly, tenX, single,dep=""):
  ...
  if tenX:
    command += "--UMI_bar "
  sbatch_file("run_class_input.sh", out_path, name,"class_input_{}".format(name), "48:00:00", "500Gb", command, dep=dep)  # 96:00:00, and 210 Gb for Lu, 100 for others for lemur blood 350G
