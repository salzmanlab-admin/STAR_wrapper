...
# Lemur smart seq sample
  data_path = "/oak/stanford/groups/krasnow/MLCA/dataSS2/Antoine_SS2/rawdata/token_A00111_0358/"+sample+"/"
  assembly = "Mmur_3.0"
          ...
          for sIO in scoreInsOpen:
            for sIB in scoreInsBase:
              ...
              #cond_run_name = run_name + "_cSM_{}_cJOM_{}_aSJMN_{}_cSRGM_{}_sIO_{}_sIB_{}".format(cSM, cJOM, aSJMN, cSRGM, sIO, sIB)
                  ...
                  out_path = "/oak/stanford/groups/krasnow/MLCA/dataSS2/Antoine_SS2/rawdata/token_A00111_0358/salzman_pipeline_output/{}/".format(cond_run_name)
